                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered bg-light" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                          <?php $no=1; foreach ($penyiangan as $penyiang): ?>
                                          <tr>
                                              <td class="">
                                                  <?php echo $no.'.' ?>
                                              </td>
                                              ...
                                              <td class="">
                                                  <?php echo $penyiang->pengelompokan ?>
                                              </td>
                                              <td class="">
                                                  <?php echo $penyiang->status_retensi ?>
                                              </td>
                                              <td class="">
                                                  <a href="<?php echo site_url('manager/users/edit/'.$penyiang->id_penyiangan) ?>"
                                                   class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
                                                  <a value="<?= site_url('manager/users/delete/'.$penyiang->id_penyiangan) ?>"  class="btn btn-small text-danger hps"><i class="fas fa-trash"></i> Delete</a>
                                              </td>
                                          </tr>
                                          <?php $no+=1; endforeach; ?>
                                        </tbody>
